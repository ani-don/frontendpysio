...
const Contact = () => {
  return (
<>
<section class="py-10 bg-[url(https://th.bing.com/th/id/R.19c2cb4b4f8db8ab6b71d5d87f52c8c7?rik=nCCzgdIfxG6ILQ&riu=http%3a%2f%2fwww.womensmedicalcenterrhodeisland.com%2fwp-content%2fuploads%2f2018%2f08%2fphysio.jpg&ehk=haR92XZ96drXzP6KcbYwaK5SWMCyFy3JvxJ8LiSWtrE%3d&risl=&pid=ImgRaw&r=0)] bg-cover bg-center bg-no-repeat  sm:py-16 lg:py-24">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-2xl mx-auto text-center">
            <h2 class="text-3xl font-bold leading-tight text-blue-900 sm:text-4xl lg:text-5xl">Contact <span className='text-red-600 '>us.</span> </h2>
            <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-blue-950">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis.</p>
        </div>
                            ...
                            <div>
                                ...
                                <div class="mt-8 space-y-7">
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <span class="block ml-3 text-base text-gray-900"> phsyiocare@gmail.com </span>
                                    </div>
